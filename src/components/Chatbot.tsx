...
type Message = {
  role: string;
  content: string;
  options?: any[]; // Make options optional
  calendlyLink?: any; // New property for Calendly link
};
...
export default function Chatbot() {
  ...
  const [showMessageInput, setShowMessageInput] = useState(false); // New state for message input
      ...
      try {
        ...
        if (!res.ok) {
          ...
          setMessages([
            ...
            {
              role: "bot",
              content: "Thank you for your message! We'll get back to you as soon as possible.",
            },
          ]);
          ...
          setTimeout(() => {
            setMessages((prevMessages) => [
              ...
              {
                role: "bot",
                content: `What else can I help you with today, ${userName || "Guest"}?`,
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            <div className="w-8 h-8 bg-white rounded-full overflow-hidden flex items-center justify-center">
              {/* SVG Avatar - Replace with your custom AI character */}
              <svg
                viewBox="0 0 36 36"
                fill="none"
          ...
          <h3 className="font-medium">AskAbhi(Dev)</h3>
        </div>
        <div className="flex items-center gap-2">
          <button
                  ...
                  >
                    ...
                    {msg.options && (
                      <div className="mt-3 space-y-2">
                        {msg.options.map((option: any, optionIndex: number) => (
                          <button
                            key={optionIndex}
